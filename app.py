...
st.text('\tЦель: построить модель, которая будет предсказывать вероятность отклика клиента на рекламное предложение на основе его демографических и поведенческих характеристик.')